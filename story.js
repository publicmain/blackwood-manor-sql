...
(function () {
  ...
  const SCENES = {
    ...
    "ch1_open": {
      ...
      photoCaption: "阿什福德庄园 · 周日上午",
      paragraphs: [
        `布伦南 把一台银色笔记本电脑放在 阿什福德庄园 楼下 客厅 那张铺着绿呢的赌牌桌上。`,
    ...
    "ch1_close": {
      paragraphs: [
        ...
        `"最后一个见到 伊莱亚斯 还活着的人，会是我们第一个去问话的人。"`
      ]
    },
    ...
    "ch2_open": {
      ...
      photoCaption: "书房 103 · 案发现场",
      paragraphs: [
        `法医在午饭前送来了精炼后的死亡时间窗：周日 00:30 – 01:30。`,
        `"一小时的窗口，"布伦南 在 客厅 来回踱步，"七个嫌疑人，一个被杀的男人，一栋有 24 个带读卡器房间的房子。"`,
        `"我需要时间线。我需要知道这一小时里——每张门卡在响什么。"`
      ]
    },
    "ch2_close": {
      paragraphs: [
        `布伦南 在白板上画了一道红线，从 23:58 到 00:48。`,
        `"马库斯 在 ToD 前 32 分钟离开。埃莉诺 在 ToD 中段，从档案室那扇连接门进入。"`,
        `"她有书房权限。她是传记作者。她那天下午借了一本 玛格丽特 的手稿。"`,
    ...
    "ch3_open": {
      ...
      paragraphs: [
        `"我曾经以为，"布伦南 一边给自己倒咖啡一边说，"读懂人心需要心理学博士学位。"`,
        `"后来我入行后才知道——只要把他们晚上 11 点之后发的短信调出来读读，就够了。"`,
        `他打开 PhoneRecords 表。"周六 14:00 到周日 03:00 之间一共 13 条记录。我们找几个特定的字眼。"`
      ]
    },
    "ch3_close": {
      paragraphs: [
        `布伦南 在白板上写了三个名字下面打了三种符号：`,
        `马库斯 — £。怕破产。`,
        `薇薇安 — §。怕失去庄园。`,
        `埃莉诺 — ?。"日记本"。"最后的篇章"。`,
        `"动机有了三个。明天，"他说，"我们看看酒窖。"`
    ...
    "ch4_open": {
      paragraphs: [
        `第二天上午，客厅 桌面上放着两本旧账册。`,
        `一本是手写的——霍奇太太 那本传奇笔记本的复印件。另一本是 彭伯顿 用 平板电脑 维护的电子台账。两本都同步进了 WineCellarLog。`,
        `"庄园的酒窖在地下，恒温 13 度，"布伦南 说，"正常情况下，凌晨没人下去。"`,
    ...
    "ch5_open": {
      paragraphs: [
        `阿什福德庄园 的图书馆有四千七百本书。每本书脊上都贴了一枚 RFID 标签。`,
        `"这是个金矿，"布伦南 站在投影前说。"杀人犯有时会读他要杀的那个人的书。"`,
    ...
    "ch5_close": {
      paragraphs: [
        `埃莉诺 手里现在有：伊莱亚斯 妹妹 玛格丽特 的未发表手稿、格洛斯特郡 1975-1985 年的领养档案、玛格丽特 的私人日记本、伊莱亚斯 的成名作。`,
        `布伦南 在白板上写了一个字：著作权。`,
        `"作家最在乎的不是钱——是名字。"`,
    ...
    "ch6_open": {
      paragraphs: [
        `"前五章你们一直在两张表之间用 INNER JOIN，"布伦南 说，"——人接刷卡、人接借书、人接瓶酒。"`,
        `"今天加一层：多表交叉印证。"`,
    ...
    "ch6_close": {
      paragraphs: [
        `布伦南 在白板上又划掉一个名字：马库斯。`,
        `埃莉诺 的 Wi-Fi 在 00:28 离线，01:35 才重新上线。整整 67 分钟——完整覆盖 ToD 窗口，比 ToD 结束晚 5 分钟。`,
    ...
    "ch7_open": {
      ...
      photoCaption: "艾琳·霍奇太太 · 管家，30 年",
      paragraphs: [
        `霍奇太太 有一本墨绿色封皮的笔记本，她在庄园服务的三十年里一直随身带着。`,
        `"我并不偷听，"她对 布伦南 说，"只是有些话——客人们觉得在饭桌上轻声说就没人听到。"`,
    ...
    "ch7_close": {
      paragraphs: [
        `埃莉诺 21:40 对 伊莱亚斯 说："今夜，宴会之后。档案室。什么都不要带。"`,
        `伊莱亚斯 22:30 在走廊回应她："你以为名字刻在大理石牌上就是家人了。"`,
        `"她说我是家人。他说不是。"布伦南 自言自语。`,
    ...
    "ch8_open": {
      paragraphs: [
        `"凶手有时候被找到，"布伦南 说，"不是因为他出现在不该出现的地方——"`,
        `"是因为他没有出现在他应该出现的地方。"`,
        `"档案室有 WiFi。可她断网了。"`
      ]
    },
    "ch8_close": {
      ...
      photoCaption: "阿尔伯特·彭伯顿 · CCTV 系统管理员",
      paragraphs: [
        `布伦南 走到白板前，从右上角那张"嫌疑人列表"上，把所有名字都画了横线。`,
        `只留下三个字：埃莉诺·赖特。`,
    ...
    "ch9_open": {
      ...
      photoCaption: "玛格丽特·布莱克伍德 · 1964 — 1986",
      paragraphs: [
        `FamilyTree 表。一张自我引用的关系表——每一行是 PersonID 跟另一个 PersonID 的关系。`,
        `"族谱是侦探最古老的工具，"布伦南 说，"比指纹早三百年。"`,
    ...
    "ch9_close": {
      ...
      paragraphs: [
        `埃莉诺 是 玛格丽特 的女儿。玛格丽特 1980 年生她时，只有 16 岁。`,
        `六年后，玛格丽特 从黑木庄园的井里走了。`,
        `伊莱亚斯 是 玛格丽特 的兄弟。埃莉诺 是他的外甥女——血缘关系封存了 44 年。`,
        `布伦南 把这条关系链画在白板上：`,
        `"动机有了。但还差一根针——能不能证明 埃莉诺 进了书房后，跟 伊莱亚斯 谈过这件事？"`,
        `"我们还需要 伊莱亚斯 自己的笔记本。"`
      ]
    },
    ...
    "ch10_open": {
      paragraphs: [
        `伊莱亚斯 的笔记本电脑被法医带走了——但里面 Scrivener 文字处理软件的自动保存日志，已经全部进了 WritingSoftwareLog 表。`,
        `"Scrivener 每三十秒就自动保存一次版本，附带预览文本。"布伦南 解释。`,
    ...
    "ch10_close": {
      paragraphs: [
        `布伦南 沉默了很久。他把笔记本电脑合上，揉了揉眉心。`,
        `伊莱亚斯 计划周日早晨在颁奖宴上公开承认《沉默时刻》部分来自妹妹。他写好了讲稿。`,
        `埃莉诺 不知道。她杀了一个 24 小时后会自己揭穿一切的男人。`,
        `"明天，"他说，"我们写最后一次查询。"`,
    ...
    "ch11_open": {
      paragraphs: [
        `第十一天清晨，布伦南 把检察官 萨拉 Mendel 请到了 客厅。`,
        `她穿着深灰色西装，头发挽成一个紧绷的发髻。她看上去十年没笑过。`,
        `"DI 布伦南，"她说，"我没有时间。给我一个查询。"`,
        `"一条 SQL，能让我说服法官签逮捕令。要满足：手段、机会、动机、行为反常、物证关联——全部在一份输出里。"`,
        `布伦南 看向桌前的你。`
      ]
    },

    // ----- Finale · 埃莉诺's confession -----
    "finale_confession": {
      photo: "portraits/Eleanor.png",
      photoCaption: "埃莉诺·赖特 · 讯问室 · 11 月 1 日",
      paragraphs: [
        `埃莉诺·赖特 在档案室被捕。她没有反抗。`,
        `讯问室里，她要了一杯茶。`,
        `"我以为没人会想到查连接门的读卡器。"她说。`,
        `布伦南 回答："读卡器不是我们查到的。是我请的几位数据分析师，把整栋庄园的日志缝在一起。"`,
        `她笑了一下。"那也是一种文学。把碎片缝成一个故事。"`,
        ``,
        `她讲了她的故事。不是辩白——是讲述。`,
        ``,
        `她 17 岁第一次知道自己是被领养的。22 岁找到生母的名字——玛格丽特·布莱克伍德。`,
        `25 岁意识到 玛格丽特 的死法、年龄、自杀前的那段日子。`,
        `她花了十年研究，把所有的碎片摆在一起。最后一片是：伊莱亚斯 处女作《沉默时刻》的初稿，跟 玛格丽特 1985 年留在 科茨沃尔德 小屋里的手稿，是同一份。`,
        ``,
        `她说她不是来杀人的。她带的是日记本，是为了让他亲口承认。她做好了——按她原本的话——"进行一场对话"。`,
        ``,
        `但 伊莱亚斯 跟她说："你以为名字刻在牌子上就是家人了？"`,
        ...
        `她以为自己听错了。`,
        `"你打算在颁奖宴上——反过来？"`,
        `"当然。我活了 67 年。玛格丽特 死了 38 年。死人不会回来争名字。活人会。"`,
        ``,
        `她拿起了书挡。`,
        ``,
        `她说她做完事走出书房，回头看见笔记本电脑屏幕上自己的名字。`,
        `她不能让别人看到 伊莱亚斯 写过她。她删了那份文件。`,
        ``,
        `她说她忘了 Scrivener 自动保存的预览不会消失。`,
        `她说她忘了连接门有读卡器。`,
        `她说她想她忘了很多很多东西。`,
        ``,
        `她说她最后一次看 玛格丽特 的画像——挂在档案室壁炉上方那张——是 01:14 am，被捕的整整十一天前。`,
        ``,
        `她说她以为她做这件事是为 玛格丽特。`,
        `她说她不知道死人想要什么。`,
        ``,
        `她说她希望——这是她最后一句话——`,
        `学生们读到这桩案子的时候，能想起 玛格丽特·布莱克伍德 这个名字。`
      ]
    },
    ...
    "prologue_01_manor": {
      photo: "portraits/Manor.png",
      photoCaption: "阿什福德庄园 · 科茨沃尔德，英格兰",
      paragraphs: [
        `周日清晨。八点四十七分。`,
        `浓雾压在 科茨沃尔德 的山谷上方。`,
        `十月的第三个周末——本来是 黑木文学奖 的颁奖周末。`,
        `阿什福德庄园，三层石砌庄园，西翼最高的窗依然亮着——昨晚没有人去关那盏灯。`,
        `庄园里住着十二个人。`,
    ...
    "prologue_02_police": {
      ...
      photoCaption: "2024 年 10 月 20 日 周日 · 上午 08:50",
      paragraphs: [
        `萨拉·惠特科姆 给庄园做了三年秘书。`,
        `她每周日上午八点二十五分准时按响后厨的指纹锁，把 伊莱亚斯·布莱克伍德 当天的报纸、邮件和早餐一并送到书房门口。`,
        `风暴吹散之后，秋天的山谷一片清冽。`,
        `她比往常迟到了五分钟。`
      ]
    },
    "prologue_03_discovery": {
      ...
      photoCaption: "萨拉·惠特科姆 · 08:30 — 发现尸体的那一刻",
      paragraphs: [
        `一小时前。`,
        `书房门把手在 萨拉 的手心打转。她敲了三声——这是规矩。`,
        `没有回应。`,
        `她推门进去。`,
        `然后她做了三件事：`,
        `一，伸手摸 伊莱亚斯 的颈动脉，没有；`,
    ...
    "prologue_04_study": {
      ...
      photoCaption: "书房 103 · 案发现场原状",
      paragraphs: [
        `书房不大。两面墙到顶的书架。`,
        `伊莱亚斯·布莱克伍德，六十七岁，三度获奖作家。`,
    ...
    "prologue_05_brennan": {
      ...
      photoCaption: "詹姆斯·布伦南 · 格洛斯特郡刑事调查科 · 09:42",
      paragraphs: [
        `上午九点四十二分。`,
        `詹姆斯·布伦南 站在书房门口。`,
    ...
    "prologue_06_command": {
      ...
      photoCaption: "客厅 · 临时指挥所",
      paragraphs: [
        `一楼 客厅。`,
        `布伦南 让人在那张铺着绿呢的赌牌桌上摆好了笔记本电脑。`,
    ...
    "prologue_07_briefing": {
      ...
      paragraphs: [
        ...
        `死者：伊莱亚斯·布莱克伍德，六十七岁。三度获奖的小说家，这座庄园的主人。`,
        `昨天，十月十九号，是黑木文学奖的颁奖夜。宾客们为他举杯。今天清晨，他被发现死在自己的书房里——头部遭钝器击打，凶器是他书桌上那只青铜书挡。`,
        `法医给出的死亡时间，是今天凌晨 00:30 到 01:30 之间。整整一小时。没有目击者。`,
        `案发当晚，庄园里一共住着十二个人：七位受邀的宾客，五名常驻的员工。他们每一个，都认识 伊莱亚斯。`,
        `书房门没有被撬，屋里没有打斗的痕迹。换句话说——开门让凶手进来的，是 伊莱亚斯 本人。`,
    ...
    "A_marcus_alibi": {
      ...
      photoCaption: "马库斯·索恩 · 客房 301 · 00:30 → 02:30",
      paragraphs: [
        `马库斯·索恩，四十九岁，文学经纪人。`,
        `当晚零点十七分回房。`,
        `把领带拉松。倒了第三杯威士忌，没喝完。`,
    ...
    "B_corridor_deadzone": {
      ...
      photoCaption: "连接走廊 · 档案室 ↔ 书房 · 无监控、无 Wi-Fi",
      paragraphs: [
        `同一时间。凌晨零点二十八分。`,
        `埃莉诺·赖特 的手机最后一次连上档案室的 Wi-Fi。`,
        `然后——`,
        `静默。`,
    ...
    "finale_epilogue": {
      ...
      paragraphs: [
        ...
        ``,
        `同一个月，`,
        `埃莉诺·赖特 在 Bristol Crown Court 被起诉为二级谋杀罪。`,
        `她没有请辩护律师。`,
        ``,
        `庭审记录第三十一页，她对法官说了一句话——`,
        `「他用了她三十八年。我只用了他一个晚上。」`,
  ...
  // Override ch7_close with new C image (霍奇 notebook)
  SCENES["ch7_close"] = {
    photo: "cutscenes/C-hodge-notebook.jpg",
    photoCaption: "艾琳·霍奇太太 · 管家 · 服务 30 年",
    paragraphs: [
      `艾琳·霍奇太太 给 阿什福德庄园 做了三十年管家。`,
      `她有一本墨绿色封皮的小本子，从不离身。`,
      `她说：「我并不偷听，先生。」`,
  ...
  SCENES["ch8_close"] = {
    ...
    photoCaption: "档案室 405 · 无监控、无公开记录",
    paragraphs: [
      `二楼最东侧的档案室。`,
      `没有监控。没有公开访客记录。`,
      `庄园里唯一一个房间——只有 伊莱亚斯 本人和「授权传记作者」 埃莉诺·赖特 能进。`,
      `埃莉诺 用了三年。`,
  ...
  SCENES["ch10_close"] = {
    ...
    photoCaption: "伊莱亚斯的笔记本电脑 · 00:38 → 00:51 · 被删除的那张便条",
    paragraphs: [
      `凌晨零点三十八分。`,
      `伊莱亚斯 坐在书桌前，给自己写一张便条——`,
      `不为发给任何人，只为整理自己的想法。`,
      ``,
      `「埃莉诺 coming in 10 min. She knows. We will settle this.」`,
      `「她有权利问。她没有权利毁了我。 —E.B.」`,
      ``,
      `他按下了 ⌘+S。`,
  ...
  const SCENE_AFTER = {
    ...
    "4.5":  "ch4_close",
    "5.3":  "ch5_close",
    // Ch6 ToD evidence revealed — TWO scenes chain: 马库斯 alibi → 埃莉诺's gap
    "6.3":  ["A_marcus_alibi", "B_corridor_deadzone"],
    "7.3":  "ch7_close",           // now with 霍奇 notebook image
    "8.4":  "ch8_close",           // Ch8 now ends on the elimination task
    // Ch9 plays the family-tree ritual (chapters.js), THEN 玛格丽特 reveal scene
  ...
  // Called by workspace.js after the 布伦南 splash monologue.
